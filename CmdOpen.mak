...
LINK_OBJS_1= \
	"$(OBJDIR)\CmdOpen.obj" \
	"$(OBJDIR)\CCmdOpen.obj" \
	"$(OBJDIR)\CCmdOpenClassFactory.obj" \
	"$(OBJDIR)\GetShieldIcon.obj" \
	"$(OBJDIR)\LoadStringEx.obj" \
	"$(OBJDIR)\RegHelpers.obj" \
	"$(OBJDIR)\DefaultHeap.obj" \
	"$(OBJDIR)\DefaultHeapNewDelete.obj" \
	"$(OBJDIR)\SimpleList.obj" \
	"$(OBJDIR)\RemoveDecorations.obj" \
	"$(OBJDIR)\Wow64.obj" \
	"$(OBJDIR)\ForceFileOperation.obj" \
	"$(OBJDIR)\CmdOpen.res"
